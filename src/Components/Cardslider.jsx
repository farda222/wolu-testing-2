...
// src/CardSlider.js
import Conference from "../assets/img/Conference-Room.png";
function CardSlider() {
  return (
    <>
      <div data-aos="fade-out" data-aos-duration="1000" data-aos-delay="600" className="container flex justify-center align-middle sm:mx-auto md:mx-auto lg:mx-auto 2xl:mx-auto mb-20">
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-2 2xl:gap-12">
          <div
            id="Card-head"
            className="w-40 h-40 bg-white border-2 border-neutral-400 border-solid rounded-md hover:border-2 overflow-y-hidden hover:bg-indigo-600 hover:text-white transition-all peer px-3 pt-6 text-black text-xs font-semibold"
            data-tilt>
            <img className="mb-3 w-10 h-10 bg-indigo-600 rounded-md" src={Conference} />
            <h1 className="mb-2">Quiz</h1>
            <p className="w-40">Managing exams and assessment.</p>
          </div>
          <div
            id="Card-head"
            className="w-40 h-40 bg-white border-2 border-neutral-400 border-solid rounded-md hover:border-2 overflow-y-hidden hover:bg-indigo-600 hover:text-white transition-all px-3 pt-6 text-black text-xs font-semibold"
            data-tilt>
            <div className="bg-indigo-600 w-fit p-2 rounded-md mb-3">
            ...
            <p>Ask anything to the teacher in real-time.</p>
          </div>
          <div
            id="Card-head"
            className="w-40 h-40 bg-white border-2 border-neutral-400 border-solid rounded-md hover:border-2 overflow-y-hidden hover:bg-indigo-600 hover:text-white transition-all peer px-3 pt-6 text-black text-xs font-semibold"
            ...
            <h1 className="mb-2">Live Class</h1>
            <p>Direct interaction with teachers and students.</p>
          </div>
          <div
            id="Card-head"
            className="w-40 h-40 bg-white border-2 border-neutral-400 border-solid rounded-md hover:border-2 overflow-y-hidden hover:bg-indigo-600 hover:text-white transition-all peer px-3 pt-6 text-black text-xs font-semibold"
            ...
            <h1 className="mb-2">Teacher & Student</h1>
            <p>Teachers and students in one tap.</p>
          </div>
        </div>
      </div>
    </>
