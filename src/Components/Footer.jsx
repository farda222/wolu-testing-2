...
const Footer = () => {
  return (
    <footer className="bg-white text-black py-8 mt-36">
      <div className="text-center mb-4 flex mx-auto justify-center items-center container">
      ...
      <div className="flex items-center justify-center container mx-auto mb-4 gap-7 mt-14">
      ...
      <div className="flex items-center justify-center container mx-auto mt-14 ml-2">
        ...
        <div className="h-16 w-[1.5px] bg-indigo-600 mr-2"></div>
        <p className="text-xs text-center w-40">Enjoy your learning with our service</p>
      </div>
